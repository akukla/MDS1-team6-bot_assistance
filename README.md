# MDS1-team6-bot_assistance

This is the final project for Team 6
...
- **tags**
  ...
  - `all_tags_revert`: [Print all tags in the reverse order]
  - `alpsort_tags`: [Print tags in the alphabetical order]
  - `alpsort_tags_revert`: [Print tags in the reversed alphabetical order]
